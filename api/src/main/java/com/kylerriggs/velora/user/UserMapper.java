...
import com.kylerriggs.velora.config.SecurityProperties;
import com.kylerriggs.velora.user.dto.UserDto;
...
public class UserMapper {
    ...
    /**
     * Updates an existing User entity with fresh data from JWT token claims. Only updates fields
     * that have changed to avoid unnecessary database writes.
     *
    ...
    /**
     * Converts a User entity to a summary DTO with basic information. Used for displaying user
     * information without sensitive data like email.
     *
     * @param user the user entity to convert
     * @return the user as a summary DTO
     */
    public UserSummaryDto toSummaryDto(User user) {
        return new UserSummaryDto(user.getId(), user.getUsername(), user.getProfileImageUrl());
    }
